...
require_once("../../includes/functions.php");
	...
	if ($mysqli->query($update3)) {
		error_log("Payment 'update3' gone through successfully");
        if ($mysqli->query($update4)) {
		error_log("Payment 'update4' gone through successfully");
        die(header("Location: ../../../index.php"));
		} else {
        error_log("Problem with payment '$update4'");
        return false;
		}
    } else {
        error_log("Problem with payment '$update3'");
        return false;
    }
?>