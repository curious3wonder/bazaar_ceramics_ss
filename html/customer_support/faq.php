...
<ul>
		...
		<li id="list2"><a title="About Us" href="../aboutus/company_bg.php" class="dropbtn">About Us &#9662;</a>
			<ul class="dropdown">
				...
				<li>
			    <a title="Design Process" href="../aboutus/design_process.php">Design Process</a></li>
				<li>
			    <a title="Production Process" href="../aboutus/production_process.php">Production Process</a></li>
				<li>
			    <a title="Our Mission" href="../aboutus/company_mission.php">Company Mission</a></li>
		    </ul>
	    </li>
		...
		<li id="list6">
		  <a title="Customer Support" href="faq.php" class="dropbtn current">Customer Support &#9662;</a>
			<ul class="dropdown"> 
				<li><a title="FAQ" class="current" href="faq.php">FAQ</a></li>
				<li>
			    <a title="Contact & Location" href="contact_location.php">Contact &#38; Location</a></li>
				<li><a title="Feedback" href="feedback.php">Feedback</a></li>
		    </ul>
	    </li> 
	  </ul>
		    <div id = "social-media">
